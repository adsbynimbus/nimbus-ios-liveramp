...
Starting with version `4.0`, NimbusLiveRampKit talks to the [ATS API](https://developers.liveramp.com/authenticatedtraffic-api/docs/ats-api-implementation-guide-for-mobile-publishers) directly and has no third-party dependencies. The LiveRamp SDK (LRAts) it previously wrapped is [scheduled to sunset in September 2026](https://developers.liveramp.com/authenticatedtraffic-api/changelog/ats-mobile-sdk-users-to-transition-to-ats-api).
...
```swift
dependencies: [
    .package(url: "https://github.com/adsbynimbus/nimbus-ios-liveramp", from: "4.0.0")
]
```
